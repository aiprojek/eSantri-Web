...
**eSantri Web** adalah aplikasi berbasis web yang dirancang untuk membantu administrasi Pondok Pesantren dalam mengelola data santri. Aplikasi ini mengutamakan privasi, kecepatan, dan kemampuan **offline-first** yang tangguh.

## 🧭 Riwayat Pengembangan

Aplikasi ini awalnya dibuat menggunakan **Google AI Studio**, lalu pengembangannya dilanjutkan dengan **Antigravity** agar proses pengembangan lebih fleksibel, terstruktur, dan mudah ditingkatkan sesuai kebutuhan.
...
- **Surat Menyurat Otomatis**: Template surat resmi dengan _Magic Draft (AI)_ dan arsip digital.
