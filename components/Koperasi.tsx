...
const Koperasi: React.FC = () => {
    const [activeTab, setActiveTab] = useState<'kasir' | 'produk' | 'supplier' | 'kasbon' | 'riwayat' | 'keuangan' | 'pengaturan'>('kasir');
        ...
        <div className="space-y-4 h-full flex flex-col">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 shrink-0 overflow-x-auto">
                <nav className="flex -mb-px">
                    ...
                    <button onClick={() => setActiveTab('supplier')} className={`flex-1 py-3 px-4 border-b-2 font-bold text-sm whitespace-nowrap ${activeTab === 'supplier' ? 'border-teal-600 text-teal-600' : 'border-transparent text-gray-500 hover:text-gray-700'}`}><i className="bi bi-truck mr-2"></i> Supplier</button>
