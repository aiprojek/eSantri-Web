...
export const ReportOptions: React.FC<ReportOptionsProps> = ({ config, filteredSantri, settings, selectedJenjangId }) => {
    ...
    switch (activeReport) {
        ...
        case ReportType.LembarAbsensi:
            return (
                <div className="w-full grid grid-cols-1 md:grid-cols-4 gap-4 border-t pt-4">
        ...
        case ReportType.LembarKedatangan:
            return (
                <div className="pt-4 border-t">
                    ...
                    <div><label htmlFor="agenda-kedatangan" className="block mb-1 text-sm font-medium text-gray-700">Keterangan Agenda</label><input type="text" id="agenda-kedatangan" value={options.agendaKedatangan} onChange={e => options.setAgendaKedatangan(e.target.value)} className="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg w-full md:w-1/2 p-2.5" placeholder="Contoh: Libur Idul Fitri 1446 H" /></div>
                </div>
            );
