...
const FEATURE_DATA: FeatureCategory[] = [
    ...
    },
    {
        ...
        items: [
            ...
            { icon: 'bi-file-earmark-spreadsheet-fill', title: 'Support Ekspor EMIS', desc: 'Download data santri format Excel yang kolomnya kompatibel dengan template upload EMIS Kemenag.' },
